...
import { MCEditHead, MCEditBody, MCEditTail, MCEditStatement, MCEditChoices, MCEditSingleChoice, MCEditSingleChoiceDecoration, MCEditAddChoiceButton } from "./providers";
    ...
    components: {
        ...
        choices: {
            ...
            single: {
                ...
                LeftDecoration: pckgDefComponents.newComp(MCEditSingleChoiceDecoration),
                RightDecoration: pckgDefComponents.newComp(MCEditSingleChoiceDecoration),
            },
